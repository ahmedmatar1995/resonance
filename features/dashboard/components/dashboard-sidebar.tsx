    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="flex flex-col gap-4 pt-4">
        <div className="flex items-center gap-2 pl-1 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:pl-0">
          ...
          />
          <span className="group-data-[collapsible=icon]:hidden font-semibold tracking-tight text-lg text-foreground">
            Resonance
          </span>
          <SidebarTrigger className="ml-auto text-foreground lg:hidden group-data-[collapsible=icon]:block" />
        </div>
        <SidebarMenu>
          <SidebarMenuItem>
      ...
      <div className="border-b mt-4 border-dashed border-border" />
      <SidebarContent>
